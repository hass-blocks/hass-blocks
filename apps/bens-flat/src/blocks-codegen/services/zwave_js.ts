...
export interface BulkSetPartialConfigParametersZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface RefreshValueZwaveJsProps {
  /**
   * Entities to refresh.
   */
  entity_id: string;
...
export interface SetValueZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface MulticastSetValueZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface PingZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface InvokeCcApiZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface RefreshNotificationsZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
...
export interface SetLockUsercodeZwaveJsProps {
  /**
...
export interface ClearLockUsercodeZwaveJsProps {
  /**
...
export interface SetLockConfigurationZwaveJsProps {
  /**
...
export interface ResetMeterZwaveJsProps {
  /**
   * The area(s) to target for this action. If an area is specified, all Z-Wave devices and entities in that area will be targeted for this action.
   */
  area_id?: never;
