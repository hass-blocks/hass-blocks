(function () {
   ...
   */
    ...
    14: [
      ...
      { '../core/DiagonalMovement': 5, '../core/Util': 9 },
    ],
    15: [
      function (require, module, exports) {
        var BiAStarFinder = require('./BiAStarFinder');
    ...
    19: [
      ...
      { '../core/DiagonalMovement': 5, './JumpPointFinderBase': 24 },
    ],
    20: [
      function (require, module, exports) {
        /**
        ...
        JPFMoveDiagonallyIfAtMostOneObstacle.prototype =
          new JumpPointFinderBase();
        JPFMoveDiagonallyIfAtMostOneObstacle.prototype.constructor =
         ...
         * @return {Array<Array<number>>} The neighbors found.
         */
        JPFMoveDiagonallyIfAtMostOneObstacle.prototype._findNeighbors =
          function (node) {
            var parent = node.parent,
              x = node.x,
              y = node.y,
    ...
    21: [
      function (require, module, exports) {
        ...
        JPFMoveDiagonallyIfNoObstacles.prototype.constructor =
