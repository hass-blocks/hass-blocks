...
declare global {
  ...
  /**
   * Backup Last attempted automatic backup
   */
  var backupLastAttemptedAutomaticBackupSensor: IEntity<`sensor.backup_last_attempted_automatic_backup`>;
  /**
   * Sun Next dawn
   */
  ...
  /**
   * shellyem-A4E57CBA73F5 Channel 1 Energy Cost
   */
...
globalThis.backupLastAttemptedAutomaticBackupSensor = entity(
