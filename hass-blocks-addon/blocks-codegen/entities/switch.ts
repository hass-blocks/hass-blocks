...
declare global {
  ...
  /**
   * Sleep Mode MQTT Switch
   */
  var toggleSleepMode: IEntity<`switch.toggle_sleep_mode`>;
  /**
   * MQTT Switch
   */
  var goodMorningPlayed: IEntity<`switch.good_morning_played`>;
}
...
globalThis.toggleSleepMode = entity(
  'switch.toggle_sleep_mode',
  'Sleep Mode MQTT Switch',
);
globalThis.goodMorningPlayed = entity(
