...
declare global {
  ...
  var turnOnRemote: (
    target: IEntity<`remote.${string}`> | IArea<string>,
    params?: TurnOnRemote,
  ) => Block<Partial<TurnOnRemote> | undefined, void>;
  ...
  ) => Block<Partial<SendCommandRemote> | undefined, void>;
  ...
  ) => Block<Partial<LearnCommandRemote> | undefined, void>;
  ...
  ) => Block<Partial<DeleteCommandRemote> | undefined, void>;
}
