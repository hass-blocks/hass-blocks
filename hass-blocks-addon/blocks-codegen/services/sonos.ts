...
declare global {
  ...
  ) => Block<Partial<SnapshotSonos> | undefined, void>;
  ...
  var restoreSonos: (
    params?: RestoreSonos,
  ) => Block<Partial<RestoreSonos> | undefined, void>;
  ...
  ) => Block<Partial<SetSleepTimerSonos> | undefined, void>;
  ...
  ) => Block<Partial<UpdateAlarmSonos> | undefined, void>;
  ...
  ) => Block<Partial<PlayQueueSonos> | undefined, void>;
  ...
  ) => Block<Partial<RemoveFromQueueSonos> | undefined, void>;
