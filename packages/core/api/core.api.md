...
z.core.output<Exclude<TProps['responseSchema'], undefined>>
>;
...
export interface IAssertionConfig<TInput, TOutput> extends IBaseBlockConfig {
    readonly predicate: (context: IRunContext<TInput>) =>
    | Promise<boolean>
    | boolean
    | {
        result: boolean;
...
// @public
interface LifeCycleEvent<T extends string>
...
TOutput = void,
TBlockOutput = void,
>(config: ILoopConfig<TInput, TOutput, TBlockOutput>): Block<TInput, TOutput>;
...
TCheckOutput extends infer Error extends {
    __error: true;
}
? Omit<Error, '__error'>
...
// @public
export const sendRemoteCommands: (
target: ITarget,
commands: string[],
) => Block_2<| Partial<{
command: string[];
...
TElseOutput,
>(
assertion: IfThenElseConditionConfig<
TInput,
TThenInput,
TElseInput,
TThenOutput,
